...
class Client(Iface):
  ...
  def getNum(self):
    self.send_getNum()
    return self.recv_getNum()

  def send_getNum(self):
    self._oprot.writeMessageBegin('getNum', TMessageType.CALL, self._seqid)
    args = getNum_args()
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_getNum(self):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
      self._iprot.readMessageEnd()
      raise x
    result = getNum_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getNum failed: unknown result");
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["getNum"] = Processor.process_getNum
  ...
  def process_getNum(self, seqid, iprot, oprot):
    args = getNum_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getNum_result()
    result.success = self._handler.getNum()
    oprot.writeMessageBegin("getNum", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class getNum_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getNum_args')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class getNum_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getNum_result')
    if self.success is not None:
